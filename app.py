...
st.set_page_config(page_title="LabFinder", layout="wide")
...
<header>
  ...
  <div class="search-wrap">
    ...
    <input type="text" id="search-input" placeholder="Buscar material, cristaleria..." autocomplete="off" autofocus>
  </div>
</header>
  ...
  <div class="panel map-panel">
    ...
    <div class="map-container">
      <svg class="lab-map" viewBox="0 0 860 510" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="254" y="480" text-anchor="middle" font-family="DM Sans,sans-serif" font-size="10" fill="#6b7280">Entrada</text>
        ...
        <g class="map-zone" id="zone-E2" onclick="filterByZone('E2')"><rect x="325" y="162" width="51" height="58" fill="#93c5fd" rx="5" stroke="#3b82f6" stroke-width="1.3"/><text x="350" y="195" text-anchor="middle" font-family="Space Mono,monospace" font-size="12" font-weight="700" fill="#1e3a8a">E2</text></g>
        <g class="map-zone" id="zone-E4" onclick="filterByZone('E4')"><rect x="390" y="162" width="51" height="58" fill="#93c5fd" rx="5" stroke="#3b82f6" stroke-width="1.3"/><text x="415" y="195" text-anchor="middle" font-family="Space Mono,monospace" font-size="12" font-weight="700" fill="#1e3a8a">E4</text></g>
        <g class="map-zone" id="zone-E1" onclick="filterByZone('E1')"><rect x="325" y="233" width="51" height="58" fill="#93c5fd" rx="5" stroke="#3b82f6" stroke-width="1.3"/><text x="350" y="266" text-anchor="middle" font-family="Space Mono,monospace" font-size="12" font-weight="700" fill="#1e3a8a">E1</text></g>
        <g class="map-zone" id="zone-E3" onclick="filterByZone('E3')"><rect x="390" y="233" width="51" height="58" fill="#93c5fd" rx="5" stroke="#3b82f6" stroke-width="1.3"/><text x="415" y="266" text-anchor="middle" font-family="Space Mono,monospace" font-size="12" font-weight="700" fill="#1e3a8a">E3</text></g>
        ...
        <g class="map-zone" id="zone-L2" onclick="filterByZone('L2')"><rect x="471" y="162" width="51" height="58" fill="#93c5fd" rx="5" stroke="#3b82f6" stroke-width="1.3"/><text x="496" y="195" text-anchor="middle" font-family="Space Mono,monospace" font-size="12" font-weight="700" fill="#1e3a8a">L2</text></g>
        <g class="map-zone" id="zone-L4" onclick="filterByZone('L4')"><rect x="536" y="162" width="51" height="58" fill="#93c5fd" rx="5" stroke="#3b82f6" stroke-width="1.3"/><text x="561" y="195" text-anchor="middle" font-family="Space Mono,monospace" font-size="12" font-weight="700" fill="#1e3a8a">L4</text></g>
        <g class="map-zone" id="zone-L1" onclick="filterByZone('L1')"><rect x="471" y="233" width="51" height="58" fill="#93c5fd" rx="5" stroke="#3b82f6" stroke-width="1.3"/><text x="496" y="266" text-anchor="middle" font-family="Space Mono,monospace" font-size="12" font-weight="700" fill="#1e3a8a">L1</text></g>
        <g class="map-zone" id="zone-L3" onclick="filterByZone('L3')"><rect x="536" y="233" width="51" height="58" fill="#93c5fd" rx="5" stroke="#3b82f6" stroke-width="1.3"/><text x="561" y="266" text-anchor="middle" font-family="Space Mono,monospace" font-size="12" font-weight="700" fill="#1e3a8a">L3</text></g>
        ...
        <g class="map-zone" id="zone-K2" onclick="filterByZone('K2')"><rect x="617" y="162" width="46" height="58" fill="#93c5fd" rx="5" stroke="#3b82f6" stroke-width="1.3"/><text x="640" y="195" text-anchor="middle" font-family="Space Mono,monospace" font-size="12" font-weight="700" fill="#1e3a8a">K2</text></g>
        <g class="map-zone" id="zone-K4" onclick="filterByZone('K4')"><rect x="677" y="162" width="46" height="58" fill="#93c5fd" rx="5" stroke="#3b82f6" stroke-width="1.3"/><text x="700" y="195" text-anchor="middle" font-family="Space Mono,monospace" font-size="12" font-weight="700" fill="#1e3a8a">K4</text></g>
        <g class="map-zone" id="zone-K1" onclick="filterByZone('K1')"><rect x="617" y="233" width="46" height="58" fill="#93c5fd" rx="5" stroke="#3b82f6" stroke-width="1.3"/><text x="640" y="266" text-anchor="middle" font-family="Space Mono,monospace" font-size="12" font-weight="700" fill="#1e3a8a">K1</text></g>
        <g class="map-zone" id="zone-K3" onclick="filterByZone('K3')"><rect x="677" y="233" width="46" height="58" fill="#93c5fd" rx="5" stroke="#3b82f6" stroke-width="1.3"/><text x="700" y="266" text-anchor="middle" font-family="Space Mono,monospace" font-size="12" font-weight="700" fill="#1e3a8a">K3</text></g>
...
const INVENTARIO = [
  ...
  {ubicacion:"F5",  descripcion:"Peptona bacteriologica",        cantidad:3,  tipo:"Reactivo"},
  ...
  {ubicacion:"F9",  descripcion:"Fosfato disodico Na2HPO4",      cantidad:5,  tipo:"Reactivo"},
  {ubicacion:"F10", descripcion:"Fosfato monopotasico KH2PO4",   cantidad:5,  tipo:"Reactivo"},
  {ubicacion:"F11", descripcion:"Hidroxido de sodio NaOH",       cantidad:8,  tipo:"Reactivo"},
  {ubicacion:"F12", descripcion:"Acido acetico glacial",         cantidad:4,  tipo:"Reactivo"},
  {ubicacion:"F13", descripcion:"Sulfato de amonio",             cantidad:6,  tipo:"Reactivo"},
  {ubicacion:"F14", descripcion:"Cloruro de calcio CaCl2",       cantidad:4,  tipo:"Reactivo"},
  {ubicacion:"F15", descripcion:"EDTA disodico",                 cantidad:3,  tipo:"Reactivo"},
  ...
  {ubicacion:"A1-2",descripcion:"Vasos de precipitados 50 mL",   cantidad:20, tipo:"Cristaleria"},
  {ubicacion:"A3-4",descripcion:"Matraces Erlenmeyer 250 mL",    cantidad:12, tipo:"Cristaleria"},
  {ubicacion:"A5-6",descripcion:"Probetas 100 mL",               cantidad:8,  tipo:"Cristaleria"},
  {ubicacion:"A7-8",descripcion:"Pipetas graduadas 10 mL",       cantidad:15, tipo:"Cristaleria"},
  {ubicacion:"A9",  descripcion:"Embudos de separacion 250 mL",  cantidad:6,  tipo:"Cristaleria"},
  {ubicacion:"E1",  descripcion:"Acido clorhidrico HCl 37%",     cantidad:3,  tipo:"Reactivo"},
  {ubicacion:"E2",  descripcion:"Acido sulfurico H2SO4 98%",     cantidad:2,  tipo:"Reactivo"},
  {ubicacion:"E3",  descripcion:"Acido nitrico HNO3 65%",        cantidad:2,  tipo:"Reactivo"},
  {ubicacion:"E4",  descripcion:"Amoniaco NH3 25%",              cantidad:3,  tipo:"Reactivo"},
  {ubicacion:"L1",  descripcion:"Buretas 50 mL",                 cantidad:8,  tipo:"Cristaleria"},
  {ubicacion:"L2",  descripcion:"Pipetas volumetricas 25 mL",    cantidad:10, tipo:"Cristaleria"},
  {ubicacion:"L3",  descripcion:"Tubos de ensayo 16x150 mm",     cantidad:50, tipo:"Cristaleria"},
  {ubicacion:"L4",  descripcion:"Frascos Schott 500 mL",         cantidad:14, tipo:"Cristaleria"},
  {ubicacion:"K1",  descripcion:"Tincion Gram set completo",      cantidad:2,  tipo:"Reactivo"},
  ...
  {ubicacion:"K4",  descripcion:"Crystal Violet solucion",       cantidad:4,  tipo:"Reactivo"},
  {ubicacion:"CONG",descripcion:"Muestras biologicas -20C",       cantidad:15, tipo:"Muestra"},
  ...
  {ubicacion:"INV", descripcion:"Stock tubos centrifuga 1.5 mL",  cantidad:60, tipo:"Plastico"},
  {ubicacion:"INV", descripcion:"Puntas micropipeta 200 uL",      cantidad:500,tipo:"Plastico"},
  {ubicacion:"INV", descripcion:"Placas Petri desechables",       cantidad:80, tipo:"Plastico"},
];
...
function renderResults(q) {
  ...
  f.forEach(function(item) {
    ...
    c.innerHTML='<div class="zone-dot" style="background:'+zc.bg+';color:'+zc.color+';border:1.5px solid '+zc.border+'">'+s+'</div><div class="card-info"><div class="card-name">'+item.descripcion+'</div><div class="card-meta"><span>ubicacion: '+item.ubicacion+'</span><span>tipo: '+item.tipo+'</span></div></div><div class="card-qty">'+item.cantidad+'<br><span style="font-size:.6rem;color:#6b7280">uds</span></div>';
    c.onclick=function(){ showDetail(item,c); }; list.appendChild(c);
  });
}
...
function showDetail(item,cardEl) {
  ...
  document.getElementById('detail-location').textContent='Ubicacion: '+item.ubicacion;
...
function highlightZone(ub) {
  document.querySelectorAll('.map-zone').forEach(function(z){z.classList.remove('highlighted');});
  if(ub.toUpperCase()==='INV'){
  ...
  var el = document.getElementById('zone-'+ub);
...
function filterByZone(prefix) {
  ...
  if(prefix==='INV'){
    ...
    var els = document.querySelectorAll('[id^="zone-'+prefix+'"]');
    els.forEach(function(el){el.classList.add('highlighted');});
  }
}

document.getElementById('search-input').addEventListener('input', function(e){ renderResults(e.target.value.trim()); });
renderResults('');
</script>
</body>
</html>"""
